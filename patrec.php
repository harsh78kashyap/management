...
$sql="SELECT pat_id,name,fathername,bloodg,gender,address,mobile,age,email FROM patient order by pat_id";
$result = $conn-> query($sql);
    if($result-> num_rows > 0)
    {
        ...
        {
            echo "<tr><td>".$row["pat_id"]."</td><td>". $row["name"]."</td><td>".$row["fathername"]."</td><td>".$row["age"]."</td><td>".$row["gender"]."</td><td>".$row["bloodg"]."</td><td>".$row["mobile"]."</td><td>".$row["address"]."</td><td>".$row["email"]."</td></tr>";
