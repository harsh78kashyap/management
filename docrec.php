...
$sql="SELECT doc_id,name,dob,experience,department,gender,address,mobile,age,college,email FROM doctor order by doc_id";
$result = $conn-> query($sql);
    if($result-> num_rows > 0)
    {
        ...
        {
            echo "<tr><td>".$row["doc_id"]."</td><td>". $row["name"]."</td><td>".$row["age"]."</td><td>".$row["gender"]."</td><td>".$row["dob"]."</td><td>".$row["department"]."</td><td>". $row["experience"]."</td><td>".$row["college"]."</td><td>".$row["mobile"]."</td><td>".$row["address"]."</td><td>".$row["email"]."</td></tr>";
            
        }
        echo "</table>";
    }
    else{
        echo "No Doctor Record";
    }
?>
