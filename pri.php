...
$sql0="SELECT name FROM doctor WHERE doc_id=$did";
$result=$conn->query($sql0);
$row=$result->fetch_assoc();
$doc=$row['name'];
$sql="INSERT INTO precription (p_id,doc_id,doctor,remark,medicine) values('$pid','$did','$doc','$re','$med')";
$conn->query($sql);
$sql1="DELETE FROM appoint WHERE p_id=$pid";
$conn->query($sql1);
$s ="UPDATE oldappoint SET message='N/A' WHERE pid=$pid";
$conn->query($s);
echo "Precription has been given to ".$pid." patient id";
