...
$sql="SELECT p_id,doc_id,remark,medicine,date,doctor FROM precription";
$result = $conn-> query($sql);
    if($result-> num_rows > 0)
    {
        ...
        {
            echo "<tr><td>".$row["p_id"]."</td><td>". $row["doc_id"]."</td><td>".$row["doctor"]."</td><td>".$row["remark"]."</td><td>".$row["medicine"]."</td><td>".$row["date"]."</td></tr>";
